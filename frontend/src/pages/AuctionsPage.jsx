...
const activeAuctions = [
    ...
    { id: 8, name: 'Platinum Alligator Gar', breeder: 'Prehistoric Pets', currentBid: 450.00, image: '/images/arowana.png', endTime: Date.now() + 2 * 86400000, badge: 'Premium' },
    { id: 9, name: 'Super Red Monkey Flowerhorn', breeder: 'Dragon King', currentBid: 280.00, image: '/images/flowerhorn.png', endTime: Date.now() + 12 * 3600000, badge: 'Ending Soon' },
    { id: 10, name: 'Black Diamond Stingray', breeder: 'Amazonia Elite', currentBid: 1500.00, image: '/images/discus.png', endTime: Date.now() + 5 * 86400000, badge: 'Rare' },
    { id: 11, name: 'Moorish Idol Pair', breeder: 'Reef Masters', currentBid: 320.00, image: '/images/angelfish.avif', endTime: Date.now() + 48 * 3600000, badge: null },
]
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span className="font-semibold">{activeAuctions.length} Active Auctions</span>
                        </span>
