...
const elusives = [
    {
        ...
        price: 12500 * 15000,
        oldPrice: 15000 * 15000,
        rarity: 9.8,
        tier: 'Tier Masterpiece',
        image: '/images/arowana.png',
        description: 'Anomali biologis tanpa pigmentasi, menghasilkan warna metalik berkilauan. Ikon prestise akuatik yang tak terbantahkan.',
        featured: true,
    },
    {
        id: 2,
        ...
        description: "Berasal dari terumbu karang dalam Kepulauan Cook. Garis-garis khas permen dan daya tahan yang luar biasa.",
        featured: false,
    },
]

const gallery = [
    { id: 3, name: 'Clarion Angelfish', sub: 'Budidaya Spesial', price: 2100 * 15000, image: '/images/angelfish.avif' },
    { id: 4, name: 'Neptune Grouper', sub: 'Muda', price: 1950 * 15000, image: '/images/mandarin.avif' },
    { id: 5, name: 'Gem Tang', sub: 'Asal Mauritius', price: 3400 * 15000, image: '/images/blue-tang.avif' },
    { id: 6, name: 'Bladefin Basslet', sub: 'Sangat Langka', price: 7200 * 15000, image: '/images/discus.avif' },
]
...
const features = [
    {
        ...
        title: 'Silsilah Terverifikasi DNA',
        desc: 'Setiap spesimen langka dilengkapi sertifikat keaslian dan asal yang didukung blockchain.',
    },
    {
        icon: (
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        title: 'Kurir Jet Pribadi',
        desc: 'Transportasi mewah dengan pemantauan suhu untuk memastikan ikan tidak stres sama sekali.',
    },
]
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-[420px] md:min-h-[500px] bg-[#051c2c] overflow-hidden flex items-center">
                ...
                <div className="absolute right-0 bottom-0 top-0 w-1/2 flex items-center justify-end pr-8 opacity-90 pointer-events-none">
                    <img src="/images/arowana.png" alt="" className="h-full max-h-[480px] object-contain object-right" />
                </div>
            ...
            <section className="px-6 md:px-16 py-14">
                <div className="flex items-end justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mt-1">Spesimen sangat langka yang tersedia saat ini di galeri terkontrol suhu kami.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="p-6">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="text-xs font-bold text-gray-500 uppercase tracking-wide">
                                    Skor Kelangkaan: <span className="text-amber-500">{elusives[0].rarity}/10</span>
                                </span>
                            </div>
                  ...
                  ${addedId === elusives[0].id ? 'bg-green-500 text-white' : 'bg-[#0f2744] text-white hover:bg-[#1a3a5c]'}`}
                            >
                                {addedId === elusives[0].id ? 'Ditambahkan ✓' : 'Beli Spesimen'}
                            </button>
                        </div>
                    </div>
            ...
            <section className="px-6 md:px-16 py-14 bg-gray-50">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="rounded-3xl overflow-hidden aspect-square bg-gray-900">
                        <img src="/images/discus.png" alt="Scale texture" className="w-full h-full object-cover opacity-80" />
                    </div>
                    {/* Text */}
                    <div>
                        <span className="text-teal-600 text-xs font-bold tracking-widest uppercase mb-4 block">
                            Eksklusivitas Dijamin
                        </span>
                        <h2 className="text-3xl md:text-4xl font-bold text-dark leading-tight mb-5">
                            Ilmu <br />Seleksi.
                        </h2>
                        <p className="text-gray-500 text-sm leading-relaxed mb-8">
                            Setiap spesimen dalam koleksi Langka melewati karantina medis dan periode adaptasi 30 hari. Kami tidak sekadar menjual ikan; kami mengurasi warisan hidup untuk lingkungan akuatik pribadi Anda.
                        </p>
                ...
                <div className="relative bg-[#0a2744] rounded-3xl overflow-hidden px-8 md:px-16 py-14 text-center">
                    ...
                    <div className="relative z-10 max-w-lg mx-auto">
                        ...
                        <p className="text-white/60 text-sm leading-relaxed mb-8">
                            Daftar untuk pemberitahuan pribadi tentang kedatangan langka baru sebelum masuk ke galeri publik. Akses ke spesimen paling eksklusif dimulai di sini.
                        </p>
                        {joined ? (
