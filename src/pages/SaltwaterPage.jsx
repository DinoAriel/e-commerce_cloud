...
const allFish = [
  { id: 1, name: 'Percula Clownfish', species: 'Amphiprion percula', price: 34.99, badge: 'Hardy', image: '/images/clownfish.avif', type: 'Clownfish', color: 'orange', temperament: 'Peaceful' },
  { id: 2, name: 'Royal Blue Tang', species: 'Paracanthurus hepatus', price: 89.00, badge: 'Active', image: '/images/blue-tang.avif', type: 'Tangs & Surgeons', color: 'blue', temperament: 'Semi-Aggressive' },
  { id: 3, name: 'Flame Angelfish', species: 'Centropyge loricula', price: 120.00, badge: 'Rare', image: '/images/angelfish.avif', type: 'Angelfish', color: 'orange', temperament: 'Semi-Aggressive' },
  { id: 4, name: 'Mandarin Dragonet', species: 'Synchiropus splendidus', price: 45.50, badge: null, image: '/images/mandarin.avif', type: 'Godies', color: 'green', temperament: 'Peaceful' },
  { id: 5, name: 'Yellow Tang', species: 'Zebrasoma flavescens', price: 180.00, badge: null, image: '/images/yellow-tang.avif', type: 'Tangs & Surgeons', color: 'yellow', temperament: 'Semi-Aggressive' },
  { id: 6, name: 'Copperband Butterfly', species: 'Chelmon rostratus', price: 62.99, badge: null, image: '/images/butterfly.avif', type: 'Angelfish', color: 'yellow', temperament: 'Peaceful' },
  { id: 7, name: 'Ocellaris Clownfish', species: 'Amphiprion ocellaris', price: 28.99, badge: 'Hardy', image: '/images/clownfish.avif', type: 'Clownfish', color: 'orange', temperament: 'Peaceful' },
  { id: 8, name: 'Purple Tang', species: 'Zebrasoma xanthurum', price: 220.00, badge: 'Rare', image: '/images/blue-tang.avif', type: 'Tangs & Surgeons', color: 'purple', temperament: 'Aggressive' },
  { id: 9, name: 'Koran Angelfish', species: 'Pomacanthus semicirculatus', price: 95.00, badge: null, image: '/images/angelfish.avif', type: 'Angelfish', color: 'blue', temperament: 'Semi-Aggressive' },
]
      ...
      <div className="relative mx-4 md:mx-8 mt-4 rounded-3xl overflow-hidden bg-[#0a2744] min-h-[220px] md:min-h-[280px] flex items-end p-8 md:p-12">
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-4">
            Saltwater<br />Collection
          </h1>
          <p className="text-white/70 text-sm md:text-base leading-relaxed">
            Dive into our curated gallery of exotic marine life. From the iconic Clownfish to the rarest Pacific Tangs, each specimen is handled with professional care.
          </p>
        </div>
      </div>
        ...
        <aside className="hidden md:block w-52 shrink-0">
          ...
          <div className="bg-[#1a3a5c] rounded-2xl p-4 text-white">
            ...
            <p className="text-white/60 text-xs leading-relaxed mb-3">
              We ensure every fish arrives healthy or your money back.
            </p>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between mb-6">
            <p className="text-sm text-gray-500">
              Showing <span className="font-bold text-dark">{filtered.length} Premium Specimens</span>
            </p>
